...
DATASET = "tripdata"
TAXI_TYPES = {'green': 'lpep_pickup_datetime'}
...
with DAG(
    ...
    for taxi_type, ds_col in TAXI_TYPES.items():
        ...
        #columns_to_check = ['SR_Flag', 'column2', 'column3']
        ...
        CREATE_BQ_TBL_QUERY = (
            ...
            FROM {BIGQUERY_DATASET}.{taxi_type}_{DATASET}_external_table;"
        )
